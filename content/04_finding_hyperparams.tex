...
between the reconstructed angle and the true angle. This angular distance, or separation, is calculated
with the \texttt{astropy.coordinates.angular\_separation} function from \texttt{astropy}. The dataset with the lowest
