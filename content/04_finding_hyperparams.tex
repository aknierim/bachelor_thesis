...
I used \todo{explain noise quantiles}noise quantiles to determine what percentage of all pixels would fall under a certain threshold. This threshold would
