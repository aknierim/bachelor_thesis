...
Once promising parameters are found, a larger dataset, containing \(\num{1331328}\) telescope events
...
(\rone{} \rightarrow \dlz{}) by a selection of waveforms. This is achieved by detecting the waveform
peak and then integrating it.
\begin{figure}
    \centering
