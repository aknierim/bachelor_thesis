...
analysis of their properties. In this chapter's \autoref{sec:data-levels}, I will describe \ctapipe{} with its different data
levels and the different analysis steps. In \autoref{sec:pipeline} I will
...
\label{sec:pipeline}
\todo{write some more about config file \rightarrow allowed telescopes configs}
