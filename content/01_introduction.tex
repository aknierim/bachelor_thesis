...
\begin{figure}
    ...
    the Crab Nebula (red circle, right hand side) -- being a standard candle gamma-ray astronomy -- is marked
    along with \glspl{snr} (green circles) and \glspl{agn} (blue circles) that \gls{fermilat}
