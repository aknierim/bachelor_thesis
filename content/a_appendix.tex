...
\subsection{Metrics}
\label{ap:metrics}
The table below shows the metrics used in this work as well as their formulas. Also shown is a confusion matrix for
...
\begin{table}
    ...
    \begin{subtable}{0.48\textwidth}
        \centering
        \rowcolors{0}{white!92!black}{}
        \adjustbox{varwidth=\linewidth,scale=0.95}{%
        \begin{tabular}{l c}
            \hiderowcolors
            {Metric} & {Calculation} \\
            \showrowcolors
